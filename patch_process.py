...
with open("artifacts/rcm-stages123-release/templates/program_uip/dashboards/process_claims.html", "r", encoding="utf-8") as f:
    text = f.read()
...
with open("artifacts/rcm-stages123-release/templates/program_uip/dashboards/process_claims.html", "w", encoding="utf-8") as f:
    f.write(text)
