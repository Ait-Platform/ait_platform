...
new_route = """
@billing_bp.route('/save_global_architecture/<int:property_id>', methods=['POST'])
@login_required
...
if 'def save_global_architecture' not in content:
    content += new_route

with open('app/program_billing/routes.py', 'w', encoding='utf-8') as f:
    f.write(content)

print("Added save_global_architecture to routes.py")
