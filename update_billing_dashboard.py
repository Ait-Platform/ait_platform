...
content = re.sub(
    r"          <!-- Row 2: Dashboard Navigation -->\s*<div class=\"flex justify-end border-b border-slate-200 mb-6 space-x-2\">\s*<a href=\"\{\{ url_for\('debtors_bp\.dashboard'\) \}\}\" class=\"px-6 py-3 text-sm font-semibold text-purple-700 bg-purple-50 hover:bg-purple-100 border-b-2 border-purple-600 rounded-t-md transition-colors\">\s*SOA \(Debtors\) &rarr;\s*</a>",
    replacement,
    content,
    flags=re.DOTALL
)
