...
<div class="max-w-4xl mx-auto py-10 px-4">
    ...
    <!-- Success Banner -->
    <div class="bg-green-600 rounded-2xl shadow-2xl overflow-hidden mb-8 transform hover:scale-105 transition duration-500">
        <div class="p-10 text-center text-white">
            <i class="fas fa-certificate text-6xl text-yellow-300 mb-6 drop-shadow-md"></i>
            <h1 class="text-4xl font-extrabold mb-4">Workshop Attendance Confirmed!</h1>
            <p class="text-xl text-green-100 mb-8 max-w-2xl mx-auto">Thank you for participating in the LITRE Reading Workshop. Your responses have been recorded, and your AIT Provider Certificate is now ready to download.</p>
            
            <a href="{{ url_for('sace_bp.certificate') }}" target="_blank" class="inline-block px-8 py-4 bg-yellow-400 hover:bg-yellow-300 text-yellow-900 font-black text-xl rounded-full shadow-[0_0_20px_rgba(250,204,21,0.5)] transition">
                <i class="fas fa-download mr-2"></i> Download AIT Provider Certificate
            </a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-200">
        <div class="p-6 bg-slate-50 border-b border-slate-200">
            <h2 class="text-2xl font-bold text-slate-800"><i class="fas fa-tasks text-indigo-500 mr-2"></i> Post-Test Review</h2>
            <p class="text-slate-600 mt-1">Review your answers against the model solutions below.</p>
        </div>
        ...
        <div class="p-6 bg-slate-50 border-t border-slate-200 text-center">
            <a href="{{ url_for('sace_bp.reading_index') }}" class="text-indigo-600 font-bold hover:text-indigo-800 transition"><i class="fas fa-arrow-left mr-2"></i> Return to SACE Reading Hub</a>
        </div>
    </div>
</div>
{% endblock %}
