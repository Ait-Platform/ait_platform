...
new_year = '''              <div>
              ...
              <div>
                <label class="block text-sm font-medium text-slate-700 mb-1">Mileage <span class="text-xs text-slate-400 font-normal">(Optional)</span></label>
                <input type="text" name="mileage" class="block w-full rounded-md border border-slate-300 px-3 py-2 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 sm:text-sm" placeholder="e.g. 125,000 km">
              </div>'''
