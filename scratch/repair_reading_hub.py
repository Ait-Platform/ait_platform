...
# 1. Update the AIT Intellectual Property tile
old_tile = '''                    <p class="text-xs text-slate-500 ml-8 mb-3">I acknowledge that the I Learn to Read English Using the LITRE Method are the protected Intellectual Property and Patented material of AIT.</p>
...
new_tile = '''                    <p class="text-xs text-slate-500 ml-8 mb-3">I acknowledge that the I Learn to Read English Using the LITRE Method are the protected Intellectual Property and Patented material of AIT.</p>
                    <div class="ml-8">
...
# 2. Append the View Pledge Modal exactly once at the end
view_modal = '''
...
# Find the absolute last occurrence of {% endblock %}
