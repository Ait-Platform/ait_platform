with open("templates/program_uip/dashboards/my_access.html", "r", encoding="utf-8") as f:
    html = f.read()
...
with open("templates/program_uip/dashboards/my_access.html", "w", encoding="utf-8") as f:
    f.write(html)
