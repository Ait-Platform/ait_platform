...
content = re.sub(
    r'<p class="text-slate-600 text-sm mt-1"><span class="font-semibold">Next Service Due:</span> \{\{ job_card\.next_service_due if job_card\.next_service_due else \'N/A\' \}\}</p>\s*</div>\s*</div>',
