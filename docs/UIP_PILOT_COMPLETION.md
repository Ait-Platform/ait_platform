...
- `app/program_uip/gateway.py`
- `app/program_uip/log_privacy.py`
- `app/program_uip/operational_routes.py`
- `app/program_uip/pilot_routes.py`
- `app/program_uip/routes.py`
- `app/program_uip/services/ai.py`
- `app/program_uip/services/governance.py`
- `app/program_uip/services/invitations.py`
- `migrations/versions/uip_p11_completion.py`
- `templates/program_uip/ai_wallet.html`
- `templates/program_uip/assistant.html`
- `templates/program_uip/audit/list.html`
- `templates/program_uip/base.html`
- `templates/program_uip/help.html`
- `templates/program_uip/invitations.html`
- `templates/program_uip/public_vote.html`
