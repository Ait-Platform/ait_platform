...
if target in content:
    ...
    content = content.replace('class="flex flex-col sm:flex-row gap-4 sm:items-end"', 'class="flex flex-col sm:flex-row gap-4 sm:items-end flex-wrap"')
