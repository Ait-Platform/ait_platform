...
old_sec_logic = """                    # AUTO-GENERATE THE 4 FOUNDATIONAL RESOLUTIONS
...
new_sec_logic = """                    # AUTO-GENERATE THE 4 FOUNDATIONAL RESOLUTIONS
...
with open("app/program_uip/routes.py", "w", encoding="utf-8") as f:
    f.write(text)
print("Updated Genesis Secretary injection with raw SQL")
