...
from app.program_uip.services import finance as f, audit, documents
from app.program_uip.operational_routes import field
...
def render(name, **values):
    ...
    return render_template("program_uip/finance/" + name + ".html", org=g.organization,
