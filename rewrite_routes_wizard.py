...
content = re.sub(regex, new_backend, content, flags=re.DOTALL)

with open('app/program_billing/routes.py', 'w', encoding='utf-8') as f:
    f.write(content)
print("Updated routes.py with wizard endpoints.")
