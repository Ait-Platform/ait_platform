        ...
        <div class="p-8 space-y-6">
          ...
          <div id="tab-content-ai" class="block">
            <div class="bg-indigo-50 border border-indigo-200 rounded-xl p-8 text-center flex flex-col items-center justify-center">
              ...
              <div id="card_upload_status" class="mt-4 p-3 rounded-lg hidden w-full max-w-sm text-sm font-semibold flex items-center justify-center gap-2">
...
start_marker = '  <!-- Manual Setup Modal -->'
end_marker = '</script>'

# Find the last occurrence of </script> after the modal
idx1 = content.find(start_marker)
idx2 = content.find(end_marker, idx1)
idx3 = content.find(end_marker, idx2 + 10) # there are multiple script tags

if idx1 != -1 and idx3 != -1:
    content = content[:idx1] + new_modal_html + content[idx3 + len(end_marker):]
