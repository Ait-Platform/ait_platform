...
def welcome():
    ...
    return render_template("retire/welcome.html")


@retire_bp.route("/about")
def about():
    return render_template("retire/about.html", modules=MODULES)
...
def entry():
    ...
    return render_template("retire/entry.html", memberships=memberships)
...
def register():
    ...
    return render_template("retire/register.html", form=form)
...
def join():
    ...
    return render_template("retire/join.html", form=form, organisation=None)
...
def request_membership(organisation_id):
    ...
    return render_template("retire/join.html", form=form, organisation=organisation)
...
def status(organisation_id):
    ...
    if membership.status == "active" and membership.approved_role_id:
        return _destination(membership)
    return render_template("retire/status.html", membership=membership)
...
def dashboard(organisation_id):
    return render_template("retire/dashboard.html", organisation=g.retirement_organisation,
...
def pending_members(organisation_id):
    ...
    return render_template("retire/pending.html", organisation=g.retirement_organisation, members=members)
...
def review_member(organisation_id, membership_id):
    ...
    return render_template("retire/review.html", organisation=g.retirement_organisation, membership=membership, form=form)
