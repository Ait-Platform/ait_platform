...
start_idx = text.find('@billing_bp.route("/billing/onboarding/save_global_architecture/<int:property_id>"')
end_idx = text.find('@billing_bp.route(\'/property/<int:property_id>/architecture_summary\')')

if start_idx != -1 and end_idx != -1:
    old_func = text[start_idx:end_idx]
    
    new_func = """@billing_bp.route("/billing/onboarding/save_global_architecture/<int:property_id>", methods=["POST"])
@login_required
...
"""
    ...
    with open('app/program_billing/routes.py', 'w', encoding='utf-8') as f:
        f.write(text)
    print("Successfully replaced save_global_architecture!")
else:
