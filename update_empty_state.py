...
content = re.sub(
    r"        \{% else %\}\s*<div class=\"text-center py-12\">\s*<i class=\"fas fa-users text-4xl text-slate-300 mb-3\"></i>\s*<h3 class=\"text-lg font-bold text-slate-700\">No Clients Found</h3>\s*<p class=\"text-slate-500 mt-1\">When you create job cards, your clients will appear here\.</p>\s*</div>\s*\{% endif %\}",
    replacement,
    content,
    flags=re.DOTALL
)
