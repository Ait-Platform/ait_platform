new_header = """<header class="mb-8 border-b border-slate-200 pb-6" style="width: 100%; display: flex; flex-direction: column; gap: 0.5rem;">
    <!-- Row 1: Title & Back Button -->
    <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
        <h1 class="text-3xl font-extrabold text-slate-900 tracking-tight" style="margin: 0;">Organogram Builder</h1>
    ...
    <div style="display: flex; justify-content: space-between; align-items: flex-end; width: 100%;">
        <p class="text-slate-500 font-medium max-w-2xl" style="margin: 0;">Map the organizational blueprint, define seats, and upload official photos.</p>
...
print("Patched organogram inline css")
