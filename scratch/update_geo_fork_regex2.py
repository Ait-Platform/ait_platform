...
pattern = r'# ---------- WALLET TOKEN SUBJECTS.*?if subject in \("cultural_fire", "culturalfire", "debtors", "mechanic", "cptd", "sace", "sace_evaluator", "sace_facilitator", "sace_participant"\):'
...
with open('app/auth/routes.py', 'w', encoding='utf-8') as f:
    f.write(content)
print("Updated auth routing with correct regex")
