...
# 1. Replace the entire contents of app-view-container
pattern = r'<div class="flex-grow p-4 overflow-y-auto bg-slate-50 min-h-0" id="app-view-container">.*?</div> <!-- Close tab-p -->'

new_container = '''<div class="flex-grow p-4 overflow-y-auto bg-slate-50 min-h-0" id="app-view-container">
  
  <div class="app-view hidden text-center" id="app-view-waiting">
      <div class="h-20 w-20 bg-green-100 rounded-full flex items-center justify-center mb-6 mx-auto">
          <i class="fas fa-check text-4xl text-green-500"></i>
      </div>
      <h3 class="text-2xl font-bold text-slate-800 mb-2">Participant Device Active</h3>
      <p class="text-slate-600 mb-6">Follow along with the facilitator on the main screen.</p>
      <div class="flex justify-center"><i class="fas fa-circle-notch fa-spin text-3xl text-indigo-300"></i></div>
  </div>

  <!-- Section B: Facilitator Evaluation (Slide 31) -->
...
text = re.sub(pattern, new_container, text, flags=re.DOTALL)
