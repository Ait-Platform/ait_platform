...
pattern = r'\{% if current_appointment and current_appointment\.position\.lower\(\) in \["secretary", "chairman", "vice chairman", "chair", "chairperson", "vice chair"\] %\}.*?Manual Override.*?\{% endif %\}'

new_block = """<div class="bg-indigo-50 rounded-xl shadow-sm p-6 border border-indigo-100">
...
print("Replaced Manual Override with 72-Hour Window Notice")
