        ...
        <div class="relative border-l-4 border-indigo-200 ml-3 md:ml-6 space-y-10">
          ...
          <div class="relative pl-8 md:pl-10">
            ...
            <div class="bg-slate-50 border border-slate-200 rounded-xl p-5 shadow-sm hover:shadow-md transition">
              <h4 class="text-lg font-bold text-slate-900 mb-2">1. Intake & Quote Generation (Step 0)</h4>
          ...
          <div class="relative pl-8 md:pl-10">
            ...
            <div class="bg-amber-50 border border-amber-200 rounded-xl p-5 shadow-sm hover:shadow-md transition">
              <h4 class="text-lg font-bold text-slate-900 mb-2">2. Client Approval & Tax Invoice</h4>
              <p class="text-sm text-slate-600">Once the client agrees to the work, click the <strong>Confirm</strong> button. The system will legally convert the Quotation into a <strong>Tax Invoice</strong>.</p>
              <div class="mt-3 bg-white p-3 rounded border border-amber-100 text-sm font-semibold text-amber-800 flex items-start">
                ...
                <span><strong>Automated Delivery:</strong> The system automatically emails the Tax Invoice to the client as a demand for payment. If they have no email, you will be prompted to WhatsApp or print it.</span>
              </div>
            </div>
          </div>
          ...
          <div class="relative pl-8 md:pl-10">
            ...
            <div class="bg-emerald-50 border border-emerald-200 rounded-xl p-5 shadow-sm hover:shadow-md transition">
              <h4 class="text-lg font-bold text-slate-900 mb-2">3. Record Payment (The Ledger)</h4>
              <p class="text-sm text-slate-600 mb-3">The job is only truly confirmed once the money is in your hands! When the client pays the deposit, open their <strong>Ledger</strong> and record the payment.</p>
          ...
          <div class="relative pl-8 md:pl-10">
            ...
            <div class="bg-slate-50 border border-slate-200 rounded-xl p-5 shadow-sm hover:shadow-md transition">
              <h4 class="text-lg font-bold text-slate-900 mb-2">4. Automated Repair Tracker</h4>
              <p class="text-sm text-slate-600">As you add parts, generate quotes, and record ledger payments, the <strong>Repair Tracker</strong> automatically builds a chronological timeline. Both you and the receptionist can easily track the exact status of the vehicle without lifting a finger.</p>
            </div>
          </div>
