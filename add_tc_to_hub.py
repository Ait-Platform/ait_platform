...
tc_html = '''
        ...
        <div class="mt-8 bg-slate-50 border border-slate-200 rounded-xl p-5 shadow-sm">
          ...
          <p class="text-xs text-slate-400 mt-3 italic">This is automatically attached to the bottom of the PDF sent to the client. You can edit this in your Shop Settings.</p>
        </div>
        {% endif %}
'''
