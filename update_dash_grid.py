...
# 1. Rename 'Preview Blank Document'
content = content.replace('Preview Blank Document', 'Preview Formatted Document')

# 2. Re-write the entire grid section for perfect control
...
content = content.replace(content_to_replace, new_grid)
