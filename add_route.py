...
content = content.replace('@mechanic_bp.route("/upload_disk", methods=["POST"])', route_code + '\n@mechanic_bp.route("/upload_disk", methods=["POST"])')

with open('app/program_mechanic/routes.py', 'w', encoding='utf-8') as f:
    f.write(content)
print("Added upload_business_card route")
