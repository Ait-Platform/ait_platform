...
old_tabs = '''<!-- Traffic Robot Tabs -->
    <div class="flex space-x-2 border-b-2 border-slate-700 pb-0 bg-slate-50 pt-2 px-4 shadow-inner z-10">
        ...
        <button class="flex items-center px-6 py-3 bg-slate-200 text-slate-600 font-bold rounded-t-lg transition border-b-2 border-slate-300 hover:bg-slate-300" id="btn-tab-f" onclick="showTab('f')">
            <span class="w-3 h-3 rounded-full bg-red-600 shadow-[0_0_8px_rgba(220,38,38,0.5)] mr-3" id="light-f"></span>
            <i class="fas fa-desktop mr-2"></i> Projector (F)
        </button>
        <button class="flex items-center px-6 py-3 bg-slate-200 text-slate-600 font-bold rounded-t-lg transition border-b-2 border-slate-300 hover:bg-slate-300" id="btn-tab-p" onclick="showTab('p')">
            <span class="w-3 h-3 rounded-full bg-red-600 shadow-[0_0_8px_rgba(220,38,38,0.5)] mr-3" id="light-p"></span>
            <i class="fas fa-mobile-alt mr-2"></i> Participant (P)
        </button>
    </div>'''
